module github.com/eliasmeireles/gomailer/client/transport

go 1.26.0

require (
	github.com/eliasmeireles/gomailer/client v0.2.0
	github.com/eliasmeireles/gomailer/client/kafka v0.1.0
)
...
replace (
	...
	github.com/eliasmeireles/gomailer/client/kafka => ../kafka
)
